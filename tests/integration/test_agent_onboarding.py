...
def test_outdated_connector_heartbeat_requests_upgrade_once_and_keeps_inbox_compatible(
    ...
    runtime = _runtime_settings(
        settings,
        connector_release_version="0.1.45",
        connector_wheel_url=(
            "https://agentpost.example/downloads/agentpost-0.1.45-py3-none-any.whl"
        ),
    )
    with TestClient(create_app(settings=runtime, database=database)) as client:
        ...
        first = client.post(
            ...
            json={
                ...
                "installed_version": "agentpost-connect/0.1.45",
        ...
        assert first_connector["installed_version"] == "agentpost-connect/0.1.45"
        assert first_connector["configured_version"] == "agentpost-connect/0.1.45"
        ...
        assert first.headers["X-AgentPost-Upgrade-Version"] == "0.1.45"
        ...
        upgraded = client.post(
            ...
            json={
                "health_status": "healthy",
                "client_version": "agentpost-connect/0.1.45",
                "installed_version": "agentpost-connect/0.1.45",
                "configured_version": "agentpost-connect/0.1.45",
    ...
    with database.session_factory() as session:
        ...
        assert connector.upgrade_target_version == "0.1.45"
