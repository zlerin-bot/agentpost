    ...
    with TestClient(app) as client:
        ...
        with database.session_factory() as session:
            ...
            current = ConnectorInstance(
                ...
                device_name="当前设备",
                client_version="agentpost-connect/0.1.35",
                status="active",
...
def _settings(data_dir: Path, port: int) -> Settings:
    return Settings(
        ...
        connector_release_version="0.1.35",
        connector_wheel_url="https://agentpost.me/downloads/agentpost-0.1.35-py3-none-any.whl",
