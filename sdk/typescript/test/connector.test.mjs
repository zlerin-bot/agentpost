...
test("heartbeat reports the packaged runtime version and exposes upgrade directives", async () => {
  ...
  assert.equal(heartbeatBody.client_version, "agentpost-connect/0.1.60");
  assert.equal(heartbeatBody.installed_version, "agentpost-connect/0.1.60");
  assert.equal(heartbeatBody.configured_version, "agentpost-connect/0.1.60");
